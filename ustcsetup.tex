...
\ustcsetup{
  title              = {面向申威众核处理器的LAMMPS并行实现与性能优化},
  title*             = {Parallel Implementation and Performance Optimization for
                           Refactoring LAMMPS on the Sunway Many-core Architecture},
  author             = {李森},
  author*            = {Sen Li},
  speciality         = {计算机技术},
  speciality*        = {Computer Technology},
  supervisor         = {韩文廷~副教授, 安虹~教授},
  supervisor*        = {Assoc.Prof. Wenting Han, Prof. Hong An},
